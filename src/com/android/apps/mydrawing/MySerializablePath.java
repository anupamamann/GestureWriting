...
import com.android.apps.mydrawing.MySerializablePath.PathAction.PathActionType;

import android.graphics.Path;

public class MySerializablePath extends Path implements Serializable {

	private static final long serialVersionUID = -5974912367682897467L;

	private ArrayList<PathAction> actions = new ArrayList<MySerializablePath.PathAction>();
